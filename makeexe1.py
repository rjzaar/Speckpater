...
extra_files = [ ("", [ICONFILE,'bible.png','readme.txt']),
               ...
               (os.path.join("locales","en","LC_MESSAGES"),glob.glob(os.path.join("locales","en","LC_MESSAGES","*.mo"))),
               (os.path.join("locales","en","LC_MESSAGES"),glob.glob(os.path.join("locales","en","LC_MESSAGES","*.po"))),
               (os.path.join("locales","fi","LC_MESSAGES"),glob.glob(os.path.join("locales","fi","LC_MESSAGES","*.mo"))),
               (os.path.join("locales","fi","LC_MESSAGES"),glob.glob(os.path.join("locales","fi","LC_MESSAGES","*.po"))),
