...
class GameLevel(gamelevel6_x.GameLevel):
    ...
    def OnStart(self):
        ...
        if base.num_bibles < base.NEEDED_BIBLES:
            self.hud.show_dialog(_(
                """Oh no! You only have %d Bibles! You need at least %d total! Dave now has to back track and pick up more Bibles!""" % (
                base.num_bibles, base.NEEDED_BIBLES)))
