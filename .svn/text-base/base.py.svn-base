...
HUD_HEIGHT_ACTIVE = SCREEN_HEIGHT / 4
HUD_HEIGHT_INACTIVE = SCREEN_HEIGHT / 7
...
def loadGame():
	...
	if os.path.exists(path) == False:
		# set the defaults
		for defEntry in saveGameKeys.items():
