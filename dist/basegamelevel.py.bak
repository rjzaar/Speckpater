...
class GameLevel(tilevid.Tilevid):
        ...
        def bible_block(g, t, a):
                ...
                s.tilepos = (t.rect.x / TILE_SIZE,t.rect.y / TILE_SIZE) # this can be used to identify the specific bible
        ...
        def OnRunSpecial1(self, g, t, a): pass
        def OnRunSpecial2(self, g, t, a): pass
        def OnRunSpecial3(self, g, t, a): pass
        def OnRunSpecial4(self, g, t, a): pass
        def OnRunSpecial5(self, g, t, a): pass
        def OnRunSpecial6(self, g, t, a): pass
        def OnRunSpecial7(self, g, t, a): pass
        def OnRunSpecial8(self, g, t, a): pass
        ...
        cdata = {
                ...
                2:(player_new,None), ## This is a new player block. There should only be one of these on a map, otherwise it will cause problems.
...
# monkey_banana_2.png
        ...
        def loadLevelGeometry(self):
                ...
                self.bounds = pygame.Rect(0, 0,
                        len(self.tlayer[0]) * TILE_SIZE, (len(self.tlayer) * TILE_SIZE) + base.HUD_HEIGHT_INACTIVE);
                ...
                self.bg.bounds = pygame.Rect(0, 0,
                        len(self.bg.tlayer[0]) * BG_TILE_SIZE, (len(self.bg.tlayer) * BG_TILE_SIZE) + base.HUD_HEIGHT_INACTIVE);
        ...
        def run(self):
                ...
                txtbx = eztext.Input(maxlength=45, x=100, y=570, color=(255,0,0), prompt="Type in the missing word to repair the Bible: ")
                while 1:
                        ...
                        for e in ev:
                            ...
                            elif (e.type is JOYBUTTONDOWN):        self.handleButton(e)
                            else: maingui.event(e)
                        ...
                        if self.player != None and ((self.player.rect.y + self.player.rect.height) > ((len(self.tlayer) - 1) * TILE_SIZE)):
