...
try:
    ...
    raise_(SystemExit, "Unable to load module. %s" % message)
...
class BuildExe(object):
    def __init__(self):
        ...
        # Name of program
        self.project_name = "SpeckPater"

        # Project url
        self.project_url = "about:none"

        # Version of program
        self.project_version = "1.0a"
        ...
        # Auhor of program
        self.author_name = "Me"
        self.author_email = "playtime@mayostudios.org"
        self.copyright = "Copyright LGPL 2011 MAYO."

        # Description
        self.project_description = "Help Speckpater collect all the Bibles."
