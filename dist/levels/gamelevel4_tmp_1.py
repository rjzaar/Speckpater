...
class GameLevel(gamelevel4_x.GameLevel, Tileset):
    ...
    def OnRunSpecial1(self, g, t, a):
        def trigger(g, s, a):
            g.hud.add_pending_dialog(
                _("\"Hmm I wonder how I'm going to get across from here.\nMaybe I should climb to that tree branch.\""))
    ...
    def OnRunSpecial3(self, g, t, a):
        def trigger(g, s, a):
            ...
            s.agroups = None  ## Remove the groups from colliding with this object in the future
            if self.puzzleFinished == 0:
                g.hud.add_pending_dialog(_("\"I wonder if I need to move something or flip a switch?\""));
