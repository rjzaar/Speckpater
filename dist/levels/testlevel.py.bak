...
class GameLevel(basegamelevel.GameLevel):
	...
	def addBlocks(self,blocks):
		for currTile in blocks:
			game.tlayer[currTile.rect.y / TILE_SIZE][currTile.rect.x / TILE_SIZE] = currTile

	def removeBlocks(self,blocks):
		for currTile in blocks:
			game.tlayer[currTile.rect.y / TILE_SIZE][currTile.rect.x / TILE_SIZE] = copy.copy(game.tlayer[0][0])
