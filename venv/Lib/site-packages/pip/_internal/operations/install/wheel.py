...
def _install_wheel(
    ...
    def all_paths():
        ...
        decoded_names = list(map(ensure_text, names))
    ...
    files = list(map(make_root_scheme_file, root_scheme_paths))
    ...
    script_scheme_files = list(map(make_data_scheme_file, script_scheme_paths))
