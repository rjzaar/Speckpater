...
class Hashable(with_metaclass(ABCMeta, object)):
    @abstractmethod
    def __hash__(self):
        return 0
...
class Iterable(with_metaclass(ABCMeta, object)):
    @abstractmethod
    def __iter__(self):
        while False:
            yield None
...
class Sized(with_metaclass(ABCMeta, object)):
    @abstractmethod
    def __len__(self):
        return 0
...
class Callable(with_metaclass(ABCMeta, object)):
    @abstractmethod
