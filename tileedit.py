...
class tdraw(gui.Widget):
    def __init__(self, w, h):
        ...
        for y in range(0, app.tile_h * 2):
            for x in range(0, app.tile_w * 2):
                s.fill(clrs[(x + y) % 2], (
                    old_div(self.rect.w * x, (app.tile_w * 2)),
                    old_div(self.rect.h * y, (app.tile_h * 2)),
                    old_div(self.rect.w, (app.tile_w * 2)) + 1,
                    old_div(self.rect.h, (app.tile_h * 2)) + 2))
        self.bg = s

        s = pygame.Surface((self.rect.w, self.rect.h)).convert_alpha()
        s.fill((0, 0, 0, 0))
        for x in range(0, app.tile_w):
            pygame.draw.line(s, (0, 0, 0), (old_div(self.rect.w * x, app.tile_w), 0),
                             (old_div(self.rect.w * x, app.tile_w), self.rect.h))
        for y in range(0, app.tile_h):
            pygame.draw.line(s, (0, 0, 0), (0, old_div(self.rect.h * y, app.tile_h)),
                             (self.rect.w, old_div(self.rect.h * y, app.tile_h)))
        self.grid = s
    ...
    def paint(self, s):
        ...
        r = app.select
        pygame.draw.rect(s, (255, 255, 255, 128),
                         Rect(old_div(r.x * self.rect.w, app.tile_w), old_div(r.y * self.rect.h, app.tile_h),
    ...
    def getpos(self, e):
        x, y = old_div((e.pos[0]) * app.tile_w, self.rect.w), old_div((e.pos[1]) * app.tile_h, self.rect.h)
        x = min(max(0, x), app.tile_w - 1)
        y = min(max(0, y), app.tile_h - 1)
        return x, y

    def getpos2(self, e):
        w = old_div(self.rect.w, app.tile_w)
        h = old_div(self.rect.h, app.tile_h)
        x, y = old_div((e.pos[0] + old_div(w, 2)) * app.tile_w, self.rect.w), old_div(
            (e.pos[1] + old_div(h, 2)) * app.tile_h, self.rect.h)
...
def _cmd_new(value):
    ...
    def onchange(value):
        ...
        ok = 0
        try:
            width, height, tile_w, tile_h = int(vv['width'].value), int(vv['height'].value), int(
                vv['tile_w'].value), int(vv['tile_h'].value)
            global cfg
            cfg['fname'] = None
            cfg['width'] = width
            cfg['height'] = height
...
def init_app():
    ...
    if os.path.isfile(cfg['palette']):
        ...
        pw, ph = 16, 6
        pdata = [(0, 0, 0, 255), (0, 0, 170, 255), (0, 170, 0, 255), (0, 170, 170, 255), (170, 0, 0, 255),
                 (170, 0, 170, 255), (170, 85, 0, 255), (170, 170, 170, 255), (85, 85, 85, 255), (85, 85, 255, 255),
                 (85, 255, 85, 255), (85, 255, 255, 255), (255, 85, 85, 255), (255, 85, 255, 255), (255, 255, 85, 255),
                 ...
                 (173, 243, 255, 255), (223, 214, 255, 255), (255, 190, 255, 255), (255, 176, 255, 255),
                 (255, 177, 237, 255), (255, 191, 185, 255), (255, 217, 145, 255), (237, 246, 128, 255),
                 (185, 255, 138, 255), (145, 255, 173, 255), (128, 255, 223, 255), (138, 255, 255, 255),
                 (197, 197, 197, 255), (0, 0, 0, 255), (0, 0, 0, 255), (255, 255, 255, 255), (129, 200, 255, 255),
                 (179, 171, 255, 255), (231, 146, 255, 255), (255, 132, 244, 255), (255, 133, 194, 255),
                 (255, 148, 141, 255), (244, 173, 101, 255), (194, 202, 84, 255), (141, 227, 94, 255),
                 (101, 240, 129, 255), (84, 240, 179, 255), (94, 225, 231, 255), (120, 120, 120, 255), (0, 0, 0, 255),
                 (0, 0, 0, 255), (192, 192, 192, 255), (57, 128, 200, 255), (108, 99, 217, 255), (160, 74, 207, 255),
                 (200, 61, 172, 255), (217, 61, 122, 255), (207, 76, 70, 255), (172, 102, 30, 255), (122, 130, 13, 255),
                 (70, 155, 23, 255), (30, 169, 57, 255), (13, 168, 108, 255), (23, 153, 160, 255), (61, 61, 61, 255),
                 (0, 0, 0, 255), (0, 0, 0, 255), (128, 128, 128, 255), (16, 87, 159, 255), (67, 58, 176, 255),
                 (119, 34, 166, 255), (159, 20, 131, 255), (176, 20, 81, 255), (166, 35, 29, 255), (131, 61, 0, 255),
                 (81, 89, 0, 255), (29, 114, 0, 255), (0, 128, 16, 255), (0, 127, 67, 255), (0, 112, 119, 255),
